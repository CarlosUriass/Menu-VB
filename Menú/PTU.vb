...
Public Class PTU
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        ...
        For i As Integer = 0 To 20 'Recorrer filas
            If matriz(i, 1) >= 60 Then
                ...
                'Ir metiendo esos datos al archivo

                cadena = matriz(i, 3) & "|" & Math.Round(utilidad_pagar, 2) & "|" & matriz(i, 4)
    ...
    Private Sub Form1_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ARCHIVO = My.Computer.FileSystem.OpenTextFileWriter("F:\Menú\Menú\TXT\PTU.TXT", True)
